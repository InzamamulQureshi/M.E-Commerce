      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-2 border-b border-[#D0C5B4] dark:border-[#2E2723]">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Link
            href="/"
            target="_blank"
            className="flex-1 sm:flex-initial px-2.5 py-1 rounded-lg border border-[#D0C5B4] dark:border-[#332A24] bg-white dark:bg-[#181412] text-[11px] font-semibold text-[#181513] dark:text-[#FAF8F5] hover:border-[#181513] dark:hover:border-[#FAF8F5] transition-colors flex items-center justify-center gap-1.5 shadow-2xs"
          >
          ...
          <Link
            ...
            className="flex-1 sm:flex-initial px-2.5 py-1 rounded-lg bg-[#A64732] text-white hover:bg-[#8D3825] dark:bg-[#E07A5F] dark:hover:bg-[#D46548] dark:text-[#181513] text-[11px] font-semibold transition-colors flex items-center justify-center gap-1.5 shadow-2xs cursor-pointer"
          >
            ...
            <div className="divide-y divide-[#EFE9DF] dark:divide-[#282320]">
              {recentOrders.length === 0 ? (
                ...
                recentOrders.map((order) => (
                  <div
                    key={order.id}
                    className="px-3 sm:px-3.5 py-2.5 sm:py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3 hover:bg-[#FAF7F2] dark:hover:bg-[#1F1A17] transition-colors"
                  >
                    <div className="flex items-center justify-between sm:justify-start gap-2.5 min-w-0">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <span className="text-xs font-semibold text-[#181513] dark:text-[#FAF8F5] truncate max-w-[120px] sm:max-w-none">
                          {order.customerName}
                        </span>
                      </div>
                      <span className="sm:hidden font-mono font-bold text-xs text-[#181513] dark:text-[#FAF8F5] shrink-0">
                        {formatCurrency(order.finalTotal)}
                      </span>
                    </div>

                    <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0 pt-1.5 sm:pt-0 border-t sm:border-t-0 border-[#F0EBE1] dark:border-[#282320]">
                      <div className="text-left sm:text-right">
                        <span className="hidden sm:block font-bold text-xs text-[#181513] dark:text-[#FAF8F5]">
                          {formatCurrency(order.finalTotal)}
                        </span>
                        <span className="text-[10px] text-[#786F64] dark:text-[#A89F91] block">
                          {formatDate(order.createdAt)}
                        </span>
                      </div>
                      <Link
                        href={`/admin/dashboard/orders?search=${order.orderNumber}`}
                        className="px-2.5 py-1 rounded-md border border-[#DDD5C7] dark:border-[#38322D] hover:border-[#181513] dark:hover:border-[#FAF8F5] text-[11px] font-semibold text-[#A64732] dark:text-[#E07A5F] flex items-center gap-0.5 transition-colors"
                      >
                        <span>Fulfill</span>
