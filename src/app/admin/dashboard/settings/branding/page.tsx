            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-10 h-10 rounded-xl cursor-pointer border border-[#D0C5B4] dark:border-[#38302A] bg-transparent p-0.5"
                />
                <input
                  type="text"
                  value={brandAccentColor}
                  onChange={(e) => setBrandAccentColor(e.target.value)}
                  placeholder="#E07A5F"
                  className="w-32 px-3 py-2 rounded-xl border border-[#D0C5B4] dark:border-[#38302A] bg-white dark:bg-[#1C1815] text-[#181513] dark:text-[#FAF8F5] text-xs font-mono outline-hidden focus:ring-1 focus:ring-[#A64732]"
                />
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[#FAF8F5] dark:bg-[#151210] border border-[#E5DFD4] dark:border-[#2A231F] rounded-2xl p-5 shadow-xs space-y-4">
            ...
            <div className="rounded-xl border border-[#D0C5B4] dark:border-[#38302A] bg-white dark:bg-[#1C1815] overflow-hidden shadow-sm">
              {/* Image banner */}
              <div className="relative aspect-[1200/630] w-full bg-[#181513] p-5 flex flex-col justify-between overflow-hidden">
                <div
                  style={{
                    position: "absolute",
                    top: "-40px",
